...
@section('title')
    @php echo $title = 'عرض ثابت' @endphp
@endsection
                                                ...
                                                <div class="card-header" style="">
                                                    ...
                                                    <!--
                                                        ...
                                                        <h3 class="card-label" style="color: #d92815">{{ $title }}
                                                            <span style="color: black"> | </span>
                                                            <small class="" style="color: #154dd9">{{ $row->label }} </small></h3>
                                                    </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" role="group" aria-label="Basic example">
                                                                            <a  href="{{ route('admin.statics.edit', $child -> id) }}"><span class="label label-lg label-light-primary label-inline mr-1 mb-1">تعديل</span></a>
                                                                            <a  href="{{ route('admin.statics.show', $child -> id) }}"><span class="label label-lg label-light-info label-inline mr-1 mb-1">عرض</span></a>
                                                                            <a href="{{ route('admin.statics.destroy', $child -> id) }}"><span class="label label-lg label-light-danger label-inline mr-1 mb-1">حذف</span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
