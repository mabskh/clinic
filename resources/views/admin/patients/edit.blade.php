                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">تعديل مريض جديد</a>
                        </li>
                       {{--  <li class="breadcrumb-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" method="POST" action="{{ route('admin.patients.update' , $patient->id) }}" >
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                        ...
                                        <label>اسم الطبيب</label>
                                            ...
                                            <select name="account_id" class="custom-select" id="inputGroupSelect02" >
                                                ...
                                                @foreach($accounts as $account)
                                                    <option  value="{{$account -> id }}"  {{$account->id == $patient->account->id  ? 'selected' : ''}} >{{$account -> full_name}}</option>
                                                @endforeach
                                                    @endif
                                           </select>
                                    ...
                                    <div class="col-lg-3">
                                        <label>الاسم </label>
                                        <input type="text" name="name" class="form-control" placeholder=""  value="{{$patient->name}}">
                                        @error('name')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
