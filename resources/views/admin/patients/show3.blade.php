        ...
        <div class="d-flex flex-column-fluid ">
            ...
            <div class="container">
                            ...
                            <div class="flex-grow-1">
                                    ...
                                    <div class="my-lg-0 my-1">
                                        ...
                                        <span
                                            class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold mr-10"><span
                                                class="mx-2" style="color: #0c0e1a">تاريخ الانتساب :</span></span>
                                ...
                                <div class="d-flex align-items-center flex-wrap justify-content-between">
                                    <div class="d-flex align-items-center flex-lg-fill mt-1  mb-1 ">
                                        ...
                                        <a href="#" class="btn btn-light-instagram btn-sm font-weight-bold mr-1"
                                           id="personal">البيانات الشخصية</a>
                                        <a href="#" class="btn btn-light-instagram btn-sm font-weight-bold mr-1"
                                           id="attachments">المرفقات</a>
                                        <a href="#" class="btn btn-light-instagram btn-sm font-weight-bold mr-1"
                                           id="status">جهات الاتصال</a>
                                        <a href="#" class="btn btn-light-instagram btn-sm font-weight-bold mr-1"
                                           id="reports">التقارير</a>
                ...
                <div class="row  m-1">
                    ...
                    <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center bg-dark-o-15  " >
