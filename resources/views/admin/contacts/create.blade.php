                                                                    ...
                                                                    <div class="col-lg-12 row">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            ...
                                                                            <div class="radio-inline">
                                                                                <label class="radio">
                                                                                    <input type="radio" value="mobile" checked name="type">
                                                                ...
                                                                <div class="col-lg-5">
                                                                        ...
                                                                        <div class="checkbox-inline mt-7">
                                                                            <label class="checkbox checkbox-outline checkbox-outline-2x mt-3 checkbox-primary ">
                                                                                <input class="" type="checkbox" value="1" name="is_primary">
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <button type="reset" onclick="window.history.go(-1); return false;" class="btn btn-secondary" >
                                                                        تراجع
                                                                    </button>
                                                                </div>
                                                            </div>
