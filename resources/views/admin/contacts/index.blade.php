...
@section('title')
    @php echo $title = 'جهات الاتصال' @endphp
@endsection
                                ...
                                <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap ">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('admin.contacts.index') }}" class="text-muted">{{ $title }}</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                                ...
                                                <div class="card-header" style="">
                                                    ...
                                                    <div class="card-title">
                                                        <h3 class="card-label" style="color: #d92815">
                                                            <i class="mr-2"></i>
                                                            <small class="" style="color: #154dd9">قائمة {{$title}} </small></h3>
                                                    </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label class="checkbox">
                                                                            <input type="checkbox" name="is_primary" id="is_primary" value="{{ $row->is_primary }}"
                                                                                {{ $row->is_primary == 1 ? 'checked' : '' }}> <span></span>
                                                                        </label>
                                                                            @endif
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" role="group" aria-label="Basic example">
                                                                            <a  href="{{ route('admin.contacts.edit', $row -> id) }}"><span class="label label-lg label-light-primary label-inline mr-1 mb-1">تعديل</span></a>
                                                                            <a href="{{ route('admin.contacts.destroy', $row -> id) }}"><span class="label label-lg label-light-danger label-inline mr-1 mb-1">حذف</span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
