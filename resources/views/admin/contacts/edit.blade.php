...
@section('title')
    @php echo $title = 'إضافة جهة اتصال' @endphp
@endsection
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('admin.contacts.index') }}" class="text-muted">جهات الاتصال</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                            ...
                                            <div class="card card-custom card-sticky " id="kt_page_sticky_card">
                                                <div class="card-header `">
                                                    <div class="card-title">
                                                        <h3 class="card-label" style="color: #d92815">{{ $title }}
                                                            <i class="mr-2"></i>
                                                            <small class="" style="color: #154dd9">  يتم اضافة جهة اتصال من خلال هذه الشاشة</small></h3>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="form" method="POST"
                                                          action="{{ route('admin.contacts.update' , $row->id) }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="col-lg-12 row">
                                                                        ...
                                                                        <div class="col-lg-4 " id="statics_list">
                                                                            ...
                                                                            <div class="radio-inline">
                                                                                <label class="radio">
                                                                                    <input type="radio" value="mobile"     name="type"
                                                                                           {{ $row->type == 'mobile' ? 'checked' : '' }}>
                                                                                    <span></span>جوال</label>
                                                                                <label class="radio">
                                                                                    <input type="radio" value="email" name="type"
                                                                                        {{ $row->type == 'email' ? 'checked' : '' }}>
                                                                                    <span></span>بريد الكتروني</label>
                                                                                <label class="radio">
                                                                                    <input type="radio" value="other" name="type"
                                                                                        {{ $row->type == 'other' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <input type="text" name="value" value="{{ $row->value }}" class="form-control" placeholder="">
                                                                    @error('value')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
                                                                ...
                                                                <div class="col-lg-5">
                                                                    ...
                                                                    <div class="checkbox-inline mt-7">
                                                                        <label class="checkbox checkbox-outline checkbox-outline-2x mt-3 checkbox-primary ">
                                                                            <input class="" type="checkbox" value="1"
                                                                            {{ $row->is_primary == 1 ? 'checked' : '' }}
                                                                                   name="is_primary">
                                                                            <span></span>تعيين إفتراضي
                                                                        </label>
                                                                        @error('is_primary')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                        @enderror
