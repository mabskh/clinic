...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/rtl/layout/general/no-aside.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2020 10:31:48 GMT -->
...
<head>
		...
		<link href="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="{{ asset('assets/plugins/global/plugins.bundle.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/plugins/custom/prismjs/prismjs.bundle.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/style.bundle.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="{{ asset('assets/css/themes/layout/header/base/light.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/header/menu/light.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/brand/light.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/aside/dark.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/brand/dark.rtl9cd7.css?v=7.1.5') }}" rel="stylesheet" type="text/css" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-transparent page-loading">
							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								...
								<div class="header-logo">
									<a href="../../index.html">
										...
										<span class="menu-text" style="color: darkorange ; font-size:large">العيادة الالكترونية</span>
									</a>
								</div>
								<!--end::Header Logo-->
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo1/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo1/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo2/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo2/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo3/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo3/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo4/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo4/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo5/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo5/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo6/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo6/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo7/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo7/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo8/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo8/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo9/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo9/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo10/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo10/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo11/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo11/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo12/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo12/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/demo13/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/demo13/rtl/layout/general/no-aside.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
...
{{--
	 ...
	 --}}	<!--end::Global Config-->
		...
		<script src="{{ asset('assets/plugins/global/plugins.bundle9cd7.js?v=7.1.5') }}"></script>
		<script src="{{ asset('assets/plugins/custom/prismjs/prismjs.bundle9cd7.js?v=7.1.5') }}"></script>
		<script src="{{ asset('assets/js/scripts.bundle9cd7.js?v=7.1.5') }}"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle9cd7.js?v=7.1.5') }}"></script>
	{{-- 	<script src="http://maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM?v=7.1.5') }}"></script> --}}
		<script src="{{ asset('assets/plugins/custom/gmaps/gmaps9cd7.js?v=7.1.5') }}"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{ asset('assets/js/pages/widgets9cd7.js?v=7.1.5') }}"></script>
        <livewire:scripts />
    ...
    <script>
        $('#alerts').delay(2000).slideUp('slow');
    </script>
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo1/rtl/layout/general/no-aside.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2020 10:31:49 GMT -->
</html>
