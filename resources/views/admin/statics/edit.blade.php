...
@section('title')
    @php echo $title = 'تعديل ثابت' @endphp
@endsection
                                            ...
                                            <div class="card card-custom card-sticky " id="kt_page_sticky_card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="form" method="POST"
                                                          action="{{ route('admin.statics.update' , $row->id ) }}"
...
<!--                                                            <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-4 ml-10 hidden" id="statics_list">
                                                                            ...
                                                                            <select name="parent_id" class="custom-select"
                                                                                ...
                                                                                @if($statics && $statics -> count() > 0)
                                                                                    @foreach($statics as $mainStatic)
                                                                                        <option
                                                                                            value="{{$row -> id }}"
                                                                                            @if($mainStatic->id == $row->parent_id) selected @endif >{{$mainStatic -> label}}
                                                                                        </option>
                                                                                    @endforeach
                                                                                @endif
                                                                            </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <h4> {{ $row->parent_id == null ? 'ثابت رئيسي' : $row->parent->label }}</h4>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <input type="text" name="label" class="form-control" value="{{ $row->label }}" placeholder="">
                                                                    @error('label')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <input type="text" name="name" class="form-control" value="{{ $row->name }}" placeholder="">
                                                                    @error('name')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
