...
@section('title')
    @php echo $title = 'ثوابت النظام   ' @endphp
@endsection
...
<!--
                                                        ...
                                                        <h3 class="card-label" style="color: #d92815">{{ $title }}
                                                            <i class="mr-2"></i>
                                                            <small class="" style="color: #154dd9">قائمة ثوابت النظام الرئيسية </small></h3>
                                                    </div>
                                                    <div class="card-toolbar">

                                                        <a href="{{ route('admin.statics.create') }}" class="btn btn-primary font-weight-bolder">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" role="group" aria-label="Basic example">
                                                                            <a  href="{{ route('admin.statics.edit', $row -> id) }}"><span class="label label-lg label-light-primary label-inline mr-1 mb-1">تعديل</span></a>
                                                                            <a  href="{{ route('admin.statics.show', $row -> id) }}"><span class="label label-lg label-light-info label-inline mr-1 mb-1">عرض</span></a>
                                                                            <a href="{{ route('admin.statics.destroy', $row -> id) }}"><span class="label label-lg label-light-danger label-inline mr-1 mb-1">حذف</span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
