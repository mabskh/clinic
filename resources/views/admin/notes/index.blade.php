...
@section('title')
    @php echo $title = "ملاحظات الطبيب" @endphp
@endsection
                                ...
                                <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap ">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('admin.notes.index') }}" class="text-muted">{{ $title }}</a>
                                            </li>
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                            ...
                                            <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                                                ...
                                                <div class="card-header" style="">
                                                    ...
                                                    <div class="card-toolbar">
                                                        ...
                                                        <a href="{{ route('admin.notes.create') }}" class="btn btn-primary font-weight-bolder">
                                                        ...
                                                        @isset($notes)
                                                            @foreach ($notes as $row)
                                                                <tr>
                                                                    ...
                                                                    <td>{!! html_entity_decode($row->note) !!}</td>
                                                                    <td>{{ $row->created_at->format('Y/m/d') }}</td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center" role="group" aria-label="Basic example">
                                                                            <a  href="{{ route('admin.notes.edit', $row -> id) }}"><span class="label label-lg label-light-primary label-inline mr-1 mb-1">تعديل</span></a>
                                                                            <a href="{{ route('admin.notes.destroy', $row -> id) }}"><span class="label label-lg label-light-danger label-inline mr-1 mb-1">حذف</span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
