...
@section('title')
    @php echo $title = 'تعديل ملاحظة' @endphp
@endsection
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('admin.notes.index') }}" class="text-muted">
                                                    ملاحظات الطبيب
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="card card-custom card-sticky " id="kt_page_sticky_card">
                                                <div class="card-header `">
                                                    <div class="card-title">
                                                        <h3 class="card-label" style="color: #d92815">{{ $title }}
                                                            <i class="mr-2"></i>
                                                            <small class="" style="color: #154dd9"> يتم تعديل ملاحظة
                                                                طبيب من خلال هذه الشاشة</small></h3>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="form" method="POST"
                                                          action="{{ route('admin.notes.update' , $note->id) }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-lg-4 " id="statics_list">
                                                                    <label>المريض</label>
                                                                    <input type="text" class="form-control" value="{{$note->patient->name}}">
                                                                </div>

                                                                <div class="col-lg-8">
                                                                    <label>الملاحظة </label>
                                                                    <textarea type="text" cols="5" rows="6" id="note"
