	...
	<ul class="menu-nav">
		<li class="menu-item menu-item-submenu menu-item-rel  menu-item-active" data-menu-toggle="click" aria-haspopup="true">
			<a href="javascript:;" class="menu-link menu-toggle">
				<span class="menu-text">ثوابت النظام</span>
				...
				<ul class="menu-subnav">
					<li class="menu-item" aria-haspopup="true">
						<a href="../../index.html" class="menu-link">
							...
							<span class="menu-text">Hello</span>
						</a>
					</li>
					<li class="menu-item" aria-haspopup="true">
                    ...
                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                        ...
                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                            <ul class="menu-subnav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href=" {{route('admin.statics.index')}} " class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">ثوابت النظام</span>
<!--                                        <span class="label label-success label-rounded"></span>-->
                                    </a>
                                </li>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{  route('admin.contacts.index') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">جهات الاتصال</span>
                                    </a>
                                </li>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{  route('admin.works.index') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">اماكن العمل</span>
                                    </a>
                                </li>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{  route('admin.notes.index') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">ملاحظات الطبيب</span>
                                    </a>
                                </li>
					...
					<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
							...
							<span class="menu-text">حسابات المستخدمين</span>
							...
							<ul class="menu-subnav">
								<li class="menu-item" aria-haspopup="true">
									<a href=" {{route('admin.users.index')}} " class="menu-link">
										...
										<span class="menu-text">عرض حسابات المستخدمين</span>
										<span class="label label-success label-rounded">{{ App\User::count() }}</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{  route('admin.users.create') }}" class="menu-link">
										...
										<span class="menu-text">اضافة مستخدم جديد</span>
									</a>
								</li>
					...
					<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
							...
							<span class="menu-text">حسابات الأطباء</span>
							<i class="menu-arrow"></i>
						</a>
						<div class="menu-submenu menu-submenu-classic menu-submenu-right">
							<ul class="menu-subnav">
								<li class="menu-item" aria-haspopup="true">
									<a href=" {{route('admin.accounts.index')}} " class="menu-link">
										...
										<span class="menu-text">عرض حسابات الأطباء</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ route('admin.accounts.create') }}" class="menu-link">
										...
										<span class="menu-text">اضافة حساب طبيب</span>
									</a>
								</li>
					...
					<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
							...
							<span class="menu-text">حسابات المرضى</span>
							<i class="menu-arrow"></i>
						</a>
						<div class="menu-submenu menu-submenu-classic menu-submenu-right">
							<ul class="menu-subnav">
								<li class="menu-item" aria-haspopup="true">
									<a href=" {{route('admin.patients.index')}} " class="menu-link">
										...
										<span class="menu-text">عرض حسابات المرضى</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ route('admin.patients.create') }}" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
										<span class="menu-text">اضافة حساب مريض</span>
									</a>
								</li>
                    ...
                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <span class="menu-text">صفات المرضى</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                            <ul class="menu-subnav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href=" {{route('admin.attributes.index')}} " class="menu-link">
                                        ...
                                        <span class="menu-text">عرض صفات المرضى</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{ route('admin.attributes.create') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">اضافة صفة مريض</span>
                                    </a>
                                </li>
